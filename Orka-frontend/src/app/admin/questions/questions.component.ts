...
export class QuestionsComponent implements OnInit {
  ...
  getlist(){
    ...
    .subscribe(res=>{
      if(res['statusCode']==200){
        ...
        this.showQns = res['data'].showQuestions.value        
      }
    },err=>{
      console.log(err)
    })
  ...
  toggleShowQuestions(value){
    console.log(value);
    
    this.toggleShowQuestionsFields['value']=value;
    this.service.authput('questions/toggleshowquestions','admin',this.toggleShowQuestionsFields)
    .pipe(first())
    .subscribe(res=>{
      if(res['statusCode']==200){
        console.log(res);  
