...
export const environment = {
    production: false,
    salesapiurl: 'https://orka-preprod.alchemylms.com/salesapi/',
    adminapiurl: 'https://orka-preprod.alchemylms.com/adminapi/',
    borrowerapiurl: 'https://orka-preprod.alchemylms.com/clientapi/',
    installerapiurl: 'https://orka-preprod.alchemylms.com/partnerapi/',
    plaidApiVersion: 'v2',
