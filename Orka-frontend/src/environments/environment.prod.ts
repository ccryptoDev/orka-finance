...
export const environment = {
  production: true,
  salesapiurl : "https://fi.orkafinance.com/sales-api/",
  adminapiurl : "https://fi.orkafinance.com/admin-api/",
  borrowerapiurl : "https://fi.orkafinance.com/borrower-api/",
  installerapiurl : "https://fi.orkafinance.com/installer-api/",
  plaidApiVersion: 'v2',
  plaidEnv: 'production', //sandbox|development|production
