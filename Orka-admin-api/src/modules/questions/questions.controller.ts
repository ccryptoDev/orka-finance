...
export class QuestionsController {
  ...
  @Put('/toggleshowquestions')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: "show questions or not when create sale" })
  async toggleShowQuestions(
    @Body() toggleValue
  ){      
      return this.questionsService.toggleShowQuestions(toggleValue)
  }
