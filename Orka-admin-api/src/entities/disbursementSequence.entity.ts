import { Entity, Column, CreateDateColumn, UpdateDateColumn, PrimaryGeneratedColumn, BaseEntity, Generated } from 'typeorm';

import { disbursementStatus } from '../configs/config.enum';

export enum DisbSequenceStatus {
  active = 'ACTIVE',
  inactive = 'INACTIVE'
}
...
export class DisbursementEntity extends BaseEntity {
  ...
  @Column({
    type: 'enum',
    enum: DisbSequenceStatus,
    default: DisbSequenceStatus.active
  })
  status: string
